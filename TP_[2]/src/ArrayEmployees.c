...
int getDataEmployee(Employee* list, int len, int nextId)
{
    ...
    if(empty!=-1)
    {
        ...
        while(salario<=0)
        {
            getFloat("ERROR. Por favor ingrese el salario del empleado (Debe ser mayor a 0): ", "ERROR. Por favor ingrese un salario valido del empleado: ", &salario);
        }
        ...
        while(sector<=0)
        {
        	getInt("ERROR. Por favor ingrese el sector del empleado (Debe ser mayor a 0): ", "ERROR. Por favor ingrese un sector valido del empleado: ", &sector);
        }
...
int addEmployee(Employee* list, int len, int id, char name[],char lastName[],float salary,int sector)
{
    ...
    if(list!=NULL && len>0 && name!=NULL && lastName!=NULL)
    {
        ...
        if(index!=-1)
        {
            ...
            toUpperFirstLetterPhrase(lastName, strlen(lastName));
...
int modifyEmployee(Employee* list, int len, int lenName)
{
    ...
    if(list!=NULL && len>0)
    {
        ...
        while(banderaModificado==-1 && confirmarId=='s')
        {
            banderaModificado = 0;
            system("cls");
            printf("--------------------------------\n");
            ...
            do//opcion
            {
                ...
                case 4:
                    ...
                    while(salario<0)
							{
								getInt("ERROR. Por favor ingrese el salario del empleado (Debe ser mayor a 0): ", "ERROR. Por favor ingrese un salario valido del empleado: ", &sector);
							}
